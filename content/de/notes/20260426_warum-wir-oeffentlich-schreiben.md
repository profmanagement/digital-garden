---
title: Warum wir öffentlich schreiben — und warum Perfektionismus dabei im Weg steht
description: Eine Notiz an mich selbst über die Spannung zwischen der Aufmerksamkeitsökonomie und der ruhigeren Praxis des digitalen Gärtnerns.
author: Maik
written_by: 75 % human
status: draft
type: seedling
...
tags:
  ...
  - pkm
language: de
translation: 20260426_why-we-write-publicly
source: Simon, H. A. (1971). Designing organizations for an information-rich world. In M. Greenberger (Ed.), Computers, communication, and the public interest (pp. 37–72). Johns Hopkins Press.
related:
  - "[[Einen digitalen Garten anlegen]]"
  - "[[Von PKM zu CKM: Kann individuelles Denken zu kollektivem Wissen werden?]]"
created: 2026-04-26
modified: 2026-04-26
version: v01
---
...
Appleton, M. (2020). A Brief History & Ethos of the Digital Garden: A newly revived philosophy for publishing personal knowledge on the web [Persönlicher Blog]. *maggieappleton*. [https://maggieappleton.com/garden-history](https://maggieappleton.com/garden-history)
